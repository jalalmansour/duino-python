...
class MutuallyExclusiveAuthError(DuinoError):
...
class AzureDuino(BaseAzureClient[httpx.Client, Stream[Any]], Duino):
    @overload
    def __init__(
        self,
        *,
...
class AsyncAzureDuino(BaseAzureClient[httpx.AsyncClient, AsyncStream[Any]], AsyncDuino):
    @overload
    def __init__(
        self,
        *,
