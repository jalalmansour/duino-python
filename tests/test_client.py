...
from duino._models import BaseModel, FinalRequestOptions
from duino._streaming import Stream, AsyncStream
from duino._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from duino._base_client import (
    DEFAULT_TIMEOUT,
...
class TestWorkloadIdentity401Retry:
    ...
    def test_workload_identity_401_retry(self, respx_mock: MockRouter) -> None:
        ...
        respx_mock.post("https://auth.duino.com/oauth/token").mock(
            side_effect=[
                httpx.Response(
                    200,
                    json={
